...
describe("Multiplier3 with PLONK", function () {
    ...
    it("Should return true for correct proof", async function () {
        //[assignment] insert your script here
        const { proof, publicSignals } = await plonk.fullProve({"a":"1","b":"2", "c":"3"}, "contracts/circuits/_plonk_Multiplier/Multiplier3_js/Multiplier3.wasm","contracts/circuits/_plonk_Multiplier/circuit_0000.zkey");
        ...
        const Input = [argv[1].toString(), argv[2].toString()];
